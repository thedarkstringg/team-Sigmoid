...
echo "These currently run interactively rather than via a standalone CLI script:"
echo "  - Emin's metrics.py / plots.py: import functions directly against"
...
echo "  - Kamal's prioritization pipeline: see examples/prioritization_example.py"
echo "    for usage; requires real FaultRisk/AccessCost/Criticality inputs in"
echo "    place of that script's synthetic example values."
echo ""
