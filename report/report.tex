...
\title{Early Fault Detection and Risk-Based Maintenance Prioritization\\
...
% substantial AI assistance used for their section/code, per the brief's
% academic-integrity disclosure requirement. Placeholder below for Ziyad's
% portion; others to add their own.
Ziyad used AI assistance (Claude) for code review, debugging support, and
drafting portions of this Method section from decisions made during
development; all architecture, training, and evaluation decisions were
made and understood by the author and are defensible independently of
the drafting assistance.
